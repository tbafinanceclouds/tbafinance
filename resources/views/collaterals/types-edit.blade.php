...
<div class="container mx-auto px-4 max-w-2xl">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold">Edit Collateral Type</h1>
    </div>

    <div class="bg-white rounded shadow p-6">
        <form action="{{ route('collaterals.types.update', $type) }}" method="POST">
            @csrf @method('PUT')
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" 
                              class="w-full border rounded px-3 py-2 @error('description') border-red-500 @enderror">{{ old('description', $type->description) }}</textarea>
